...
\cite{KinMolKav2019} provide a rich overview
of the various approaches to motion planning with non-linear
constraints.
...
planner~\cite{cambon:hal-01976081}.
...
\noindent
{\scriptsize\texttt{xhost +\\docker run --rm -it --name hpp \\--volume="/tmp/.X11-unix:/tmp/.X11-unix"\\ gitlab.laas.fr:4567/humanoid-path-planner/hpp-doc/\\ journal2020}}
